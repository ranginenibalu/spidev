...
int main(int argc, char *argv[])
{
	int ret = 0;
	int retu;
	pthread_t t1, t2, t3 ; // declare 2 threads.
	
	parse_opts(argc, argv);

	FILE *fs1 = fopen("log_spi.dat", "w");
	FILE *fs2 = fopen("log_uart.dat", "w");
...
//UART
	...
	pthread_create( &t3, NULL, file_transfer, NULL); // This thread is for Transfer of SPI & Uart files to the Host.
